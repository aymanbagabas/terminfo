...
// boolNameCaps are the bool term cap names.
var boolNameCaps = map[string]int{
	"bw":    AutoLeftMargin,
	"am":    AutoRightMargin,
	"xsb":   NoEscCtlc,
	"xhp":   CeolStandoutGlitch,
	"xenl":  EatNewlineGlitch,
	"eo":    EraseOverstrike,
	"gn":    GenericType,
	"hc":    HardCopy,
	"km":    HasMetaKey,
	...
	"db":    MemoryBelow,
	"mir":   MoveInsertMode,
	"msgr":  MoveStandoutMode,
	"os":    OverStrike,
	"eslok": StatusLineEscOk,
	"xt":    DestTabsMagicSmso,
	"hz":    TildeGlitch,
	"ul":    TransparentUnderline,
	"xon":   XonXoff,
	"nxon":  NeedsXonXoff,
	"mc5i":  PrtrSilent,
	"chts":  HardCursor,
	"nrrmc": NonRevRmcup,
	"npc":   NoPadChar,
	"ndscr": NonDestScrollRegion,
	"ccc":   CanChange,
	"bce":   BackColorErase,
	"hls":   HueLightnessSaturation,
	"xhpa":  ColAddrGlitch,
	"crxm":  CrCancelsMicroMode,
	"daisy": HasPrintWheel,
	"xvpa":  RowAddrGlitch,
	"sam":   SemiAutoRightMargin,
	"cpix":  CpiChangesRes,
	"lpix":  LpiChangesRes,
	"OTbs":  BackspacesWithBs,
	"OTns":  CrtNoScrolling,
	"OTnc":  NoCorrectlyWorkingCr,
	"OTMT":  GnuHasMetaKey,
	"OTNL":  LinefeedIsNewline,
	"OTpt":  HasHardwareTabs,
	"OTxr":  ReturnDoesClrEol,
}

// numNameCaps are the num term cap names.
var numNameCaps = map[string]int{
	"cols":   Columns,
	"it":     InitTabs,
	"lines":  Lines,
	"lm":     LinesOfMemory,
	"xmc":    MagicCookieGlitch,
	"pb":     PaddingBaudRate,
	"vt":     VirtualTerminal,
	"wsl":    WidthStatusLine,
	"nlab":   NumLabels,
	...
	"pairs":  MaxPairs,
	"ncv":    NoColorVideo,
	"bufsz":  BufferCapacity,
	"spinv":  DotVertSpacing,
	"spinh":  DotHorzSpacing,
	"maddr":  MaxMicroAddress,
	"mjump":  MaxMicroJump,
	"mcs":    MicroColSize,
	"mls":    MicroLineSize,
	"npins":  NumberOfPins,
	"orc":    OutputResChar,
	"orl":    OutputResLine,
	"orhi":   OutputResHorzInch,
	"orvi":   OutputResVertInch,
	"cps":    PrintRate,
	"widcs":  WideCharSize,
	"btns":   Buttons,
	"bitwin": BitImageEntwining,
	"bitype": BitImageType,
	"OTug":   MagicCookieGlitchUl,
	"OTdC":   CarriageReturnDelay,
	"OTdN":   NewLineDelay,
	"OTdB":   BackspaceDelay,
	"OTdT":   HorizontalTabDelay,
	"OTkn":   NumberOfFunctionKeys,
}

// stringNameCaps are the string term cap names.
var stringNameCaps = map[string]int{
	"cbt":      BackTab,
	"bel":      Bell,
	"cr":       CarriageReturn,
	"csr":      ChangeScrollRegion,
	"tbc":      ClearAllTabs,
	"clear":    ClearScreen,
	"el":       ClrEol,
	"ed":       ClrEos,
	"hpa":      ColumnAddress,
	"cmdch":    CommandCharacter,
	"cup":      CursorAddress,
	"cud1":     CursorDown,
	"home":     CursorHome,
	"civis":    CursorInvisible,
	"cub1":     CursorLeft,
	"mrcup":    CursorMemAddress,
	"cnorm":    CursorNormal,
	"cuf1":     CursorRight,
	"ll":       CursorToLl,
	"cuu1":     CursorUp,
	"cvvis":    CursorVisible,
	"dch1":     DeleteCharacter,
	"dl1":      DeleteLine,
	"dsl":      DisStatusLine,
	"hd":       DownHalfLine,
	"smacs":    EnterAltCharsetMode,
	"blink":    EnterBlinkMode,
	"bold":     EnterBoldMode,
	"smcup":    EnterCaMode,
	"smdc":     EnterDeleteMode,
	"dim":      EnterDimMode,
	"smir":     EnterInsertMode,
	"invis":    EnterSecureMode,
	"prot":     EnterProtectedMode,
	"rev":      EnterReverseMode,
	"smso":     EnterStandoutMode,
	"smul":     EnterUnderlineMode,
	"ech":      EraseChars,
	"rmacs":    ExitAltCharsetMode,
	"sgr0":     ExitAttributeMode,
	"rmcup":    ExitCaMode,
	"rmdc":     ExitDeleteMode,
	"rmir":     ExitInsertMode,
	"rmso":     ExitStandoutMode,
	"rmul":     ExitUnderlineMode,
	"flash":    FlashScreen,
	"ff":       FormFeed,
	"fsl":      FromStatusLine,
	"is1":      Init1string,
	...
	"op":       OrigPair,
	"oc":       OrigColors,
	"initc":    InitializeColor,
	"initp":    InitializePair,
	"scp":      SetColorPair,
	"setf":     SetForeground,
	"setb":     SetBackground,
	"cpi":      ChangeCharPitch,
	...
	"cvr":      ChangeResVert,
	"defc":     DefineChar,
	"swidm":    EnterDoublewideMode,
	"sdrfq":    EnterDraftQuality,
	"sitm":     EnterItalicsMode,
	"slm":      EnterLeftwardMode,
	"smicm":    EnterMicroMode,
	"snlq":     EnterNearLetterQuality,
	"snrmq":    EnterNormalQuality,
	"sshm":     EnterShadowMode,
	"ssubm":    EnterSubscriptMode,
	"ssupm":    EnterSuperscriptMode,
	"sum":      EnterUpwardMode,
	"rwidm":    ExitDoublewideMode,
	"ritm":     ExitItalicsMode,
	"rlm":      ExitLeftwardMode,
	"rmicm":    ExitMicroMode,
	"rshm":     ExitShadowMode,
	"rsubm":    ExitSubscriptMode,
	"rsupm":    ExitSuperscriptMode,
	"rum":      ExitUpwardMode,
	"mhpa":     MicroColumnAddress,
	"mcud1":    MicroDown,
	"mcub1":    MicroLeft,
	"mcuf1":    MicroRight,
	"mvpa":     MicroRowAddress,
	"mcuu1":    MicroUp,
	"porder":   OrderOfPins,
	"mcud":     ParmDownMicro,
	"mcub":     ParmLeftMicro,
	...
	"mcuu":     ParmUpMicro,
	"scs":      SelectCharSet,
	"smgb":     SetBottomMargin,
	"smgbp":    SetBottomMarginParm,
	"smglp":    SetLeftMarginParm,
	"smgrp":    SetRightMarginParm,
	"smgt":     SetTopMargin,
	"smgtp":    SetTopMarginParm,
	"sbim":     StartBitImage,
	"scsd":     StartCharSetDef,
	"rbim":     StopBitImage,
	"rcsd":     StopCharSetDef,
	"subcs":    SubscriptCharacters,
	"supcs":    SuperscriptCharacters,
	"docr":     TheseCauseCr,
	"zerom":    ZeroMotion,
	"csnm":     CharSetNames,
	"kmous":    KeyMouse,
	...
	"reqmp":    ReqMousePos,
	"getm":     GetMouse,
	"setaf":    SetAForeground,
	"setab":    SetABackground,
	"pfxl":     PkeyPlab,
	"devt":     DeviceType,
	"csin":     CodeSetInit,
	"s0ds":     Set0DesSeq,
	...
	"smglr":    SetLrMargin,
	"smgtb":    SetTbMargin,
	"birep":    BitImageRepeat,
	"binel":    BitImageNewline,
	"bicr":     BitImageCarriageReturn,
	"colornm":  ColorNames,
	"defbi":    DefineBitImageRegion,
	"endbi":    EndBitImageRegion,
	"setcolor": SetColorBand,
	"slines":   SetPageLength,
	"dispc":    DisplayPcChar,
	"smpch":    EnterPcCharsetMode,
	"rmpch":    ExitPcCharsetMode,
	"smsc":     EnterScancodeMode,
	"rmsc":     ExitScancodeMode,
	"pctrm":    PcTermOptions,
	"scesc":    ScancodeEscape,
	"scesa":    AltScancodeEsc,
	"ehhlm":    EnterHorizontalHlMode,
	"elhlm":    EnterLeftHlMode,
	"elohlm":   EnterLowHlMode,
	"erhlm":    EnterRightHlMode,
	"ethlm":    EnterTopHlMode,
	"evhlm":    EnterVerticalHlMode,
	"sgr1":     SetAAttributes,
	"slength":  SetPglenInch,
	"OTi2":     TermcapInit2,
	"OTrs":     TermcapReset,
	"OTnl":     LinefeedIfNotLf,
	"OTbc":     BackspaceIfNotBs,
	"OTko":     OtherNonFunctionKeys,
	"OTma":     ArrowKeyMap,
	"OTG2":     AcsUlcorner,
	"OTG3":     AcsLlcorner,
	"OTG1":     AcsUrcorner,
